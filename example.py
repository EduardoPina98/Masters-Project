...
menu_options = {
    ...
    "c": f"Get sleep data for '{today.isoformat()}'", #TODO: FIX THE SLEEP DATA COLLECTION 
    ...
    if api:
        try:
            ...
            # USER STATISTIC SUMMARIES
                ...
                output_file = "stats_and_body_composition.json"
                ...
                try:
                    ...
                    existing_data = []  # Initialize as an empty list if file doesn't exist or is corrupted

                # Fetch new stats and body composition data
                new_data = api.get_stats_and_body(today.isoformat())  # Call API for stats and body composition data
                ...
                print(f"Stats and Body Composition data appended to {output_file}")
            ...
            # USER STATISTICS LOGGED
                ...
                # Fetch new steps data
                new_data = api.get_daily_steps(startdate.isoformat(), today.isoformat())  # Call API for step data
                ...
                # Fetch new hydration data
                new_data = api.get_hydration_data(today.isoformat())  # Call API for hydration data
                ...
                print(f"Hydration data appended to {output_file}")
            elif i == "c":
                ...
                new_data = api.get_sleep_data(today.isoformat())  # Call API for sleep data
                ...
                print(f"Sleep data appended to {output_file}")
            elif i == "d":
                ...
                # Fetch new data
                new_data = api.get_respiration_data(today.isoformat())  # Call API for respiration data
                ...
                print(f"Respiration data appended to {output_file}")
            elif i == "f":
                ...
                # Fetch new data
                new_data = api.get_spo2_data(today.isoformat())
                ...
                print(f"SpO2 data saved to {output_file}")
            elif i == "g":
                ...
                # Fetch new data
                new_data = api.get_max_metrics(today.isoformat())  # Replace with the correct API call for metrics
            ...
            # WEIGHT-INS
                ...
                # Fetch new daily weigh-ins data
                new_data = api.get_daily_weigh_ins(today.isoformat())  # Call API for daily weight data
                ...
                print(f"Daily Weight data appended to {output_file}")
            elif i == "D":
            ...
            # get_menstrual_calendar_data(self, startdate: str, enddate: str) takes two dates and returns summaries of cycles that have days between the two days
                ...
                # Fetch new fitness age data
                new_data = api.get_fitnessage_data(today.isoformat())  # Call API for fitness age data
                ...
                print(f"Fitness Age data appended to {output_file}")
